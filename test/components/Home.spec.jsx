...
describe('<Home/>', () => {
  ...
  it('should render without exploding', () => {
    expect(HomeWrapper.length)
      .to
      .equal(1);
  });

  it('should render MainContainer component', () => {
    expect(HomeWrapper.find('MainContainer').length)
      .to
      .equal(1);
  });

  it('should have all the expected elements', () => {
    const elements = [< h1 > Github Battles < /h1>,
      <p className="lead"> Some fancy motto</p >];
    expect(HomeWrapper.contains(elements))
      .to
      .equal(true);
  });
