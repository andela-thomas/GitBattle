...
describe('<Loading />', () => {
  ...
  context('When the component is mounted', () => {
    ...
    it('Should render with default props', () => {
      ...
      expect(LoadingWrapper.props().text)
        .to
        .equal('Loading');
      expect(LoadingWrapper.props().speed)
        .to
        .equal(300);
    });
    ...
    it('calls componentDidMount', () => {
      ...
      const Loadingwrapper = mount(<Loading/>);
      expect(Loading.prototype.componentDidMount.calledOnce)
        .to
        .equal(true);
    });
    ...
    it('calls componentWillUnmount', () => {
      ...
      expect(Loading.prototype.componentWillUnmount.calledOnce)
        .to
        .equal(true);
    });
  });
